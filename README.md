...
• každý úkol má název, popis, datum vytvoření, termín splnění, stav (hotovo / in progress (z části hotový) / nehotovo)

• každý úkol může být přiřazen jednomu uživateli a může mít více štítků

• aplikace umožňuje vytvářet, editovat a mazat úkoly, uživatele a štítky

• vaplikace umožňuje filtrovat úkoly podle uživatele, štítku a stavu
